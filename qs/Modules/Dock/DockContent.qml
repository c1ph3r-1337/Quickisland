          ...
          delegate: Item {
            ...
            Item {
              ...
              IconImage {
                ...
                layer.enabled: !appButton.isActive && (Settings.data.dock.colorizeIcons || (Settings.data.colorSchemes.themedIcons !== undefined && Settings.data.colorSchemes.themedIcons))
                layer.smooth: true
                layer.effect: ShaderEffect {
                  property color targetColor: (Settings.data.colorSchemes.themedIcons !== undefined && Settings.data.colorSchemes.themedIcons) ? Color.mPrimary : (Settings.data.colorSchemes.darkMode ? Color.mOnSurface : Color.mSurfaceVariant)
                  property real colorizeMode: (Settings.data.colorSchemes.themedIcons !== undefined && Settings.data.colorSchemes.themedIcons) ? 1.0 : 0.0 // 1.0 is Tray mode
