...
PanelWindow {
  ...
  WlrLayershell.namespace: "quickisland-background-" + (screen?.name || "unknown")
  ...
  Item {
    ...
    LauncherSpace {
      id: launcherSpacePanel
      objectName: "launcherSpacePanel-" + (root.screen?.name || "unknown")
      screen: root.screen
    }
    ...
    ProfileSelector {
      id: profileSelectorPanel
      objectName: "profileSelectorPanel-" + (root.screen?.name || "unknown")
      screen: root.screen
    }
