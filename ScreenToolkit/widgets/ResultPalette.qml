        ...
        Column {
            ...
            Grid {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        width: Math.floor((root.width - Style.marginS * 2) / 3)
                        height: width * 0.7
                        radius: Style.radiusM
                        color: modelData
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        root._copy(css)
                        ToastService.notify(pluginApi?.tr("panel.cssVarsCopied"), "", "copy", root.paletteColors[0] || "", 3000, "", null)
                    }
                }
            }
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        ToastService.notify(pluginApi?.tr("panel.hexListCopied"), "", "list", root.paletteColors[0] || "", 3000, "", null)
                    }
                }
            }
            Rectangle {
