...
Item {
    ...
    width: parent ? parent.width : contentPreferredWidth
    ...
    Component.onCompleted: {
        ...
        Qt.callLater(function() {
            Logger.i("ScreenToolkit", "LAYOUTDEBUG: root.width=" + root.width + " root.height=" + root.height + " mainCol.implicitHeight=" + mainCol.implicitHeight + " mainCol.height=" + mainCol.height + " toolsCol.implicitHeight=" + (typeof toolsCol !== "undefined" ? toolsCol.implicitHeight : "undefined") + " toolBar.height=" + (typeof toolBar !== "undefined" ? toolBar.height : "undefined") + " toolkitMainContent.implicitHeight=" + toolkitMainContent.implicitHeight)
        })
    }
    Rectangle {
        id: panelContainer
        ...
        Column {
            ...
            Item {
                ...
                Row {
                    ...
                    // Back button (always visible to navigate back/close)
                    Rectangle {
                        width: 32
                        height: 32
                        radius: Style.radiusM
                        visible: true
                        color: backMA.containsMouse ? Color.mHover : "transparent"
                        NIcon {
                            anchors.centerIn: parent
                            icon: "arrow-left"
                            color: backMA.containsMouse ? Color.mOnHover : Color.mOnSurface
                        }
                        MouseArea {
                            id: backMA
                            anchors.fill: parent
                    ...
                    NText {
                        text: root.showSettings ? (pluginApi?.tr("settings.title") ?? "Settings") : (pluginApi?.tr("panel.title") ?? "Screen Toolkit")
                ...
                Rectangle {
                    ...
                    color: settingsMA.containsMouse ? Color.mHover : "transparent"
                    NIcon {
                        anchors.centerIn: parent
                        icon: "settings"
                        color: settingsMA.containsMouse ? Color.mOnHover : Color.mOnSurfaceVariant
                    }
                    MouseArea {
                        id: settingsMA
                        anchors.fill: parent
        ...
        } // end of toolkitMainContent Column
    ...
    } // end of mainCol Column
} // end of panelContainer Rectangle
